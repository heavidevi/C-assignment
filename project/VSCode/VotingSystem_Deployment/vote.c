...
// Define raygui control IDs if not already defined
#ifndef DEFAULT
#define DEFAULT 0
#endif
#ifndef LABEL
...
// raygui style properties
#ifndef BORDER_COLOR_NORMAL
#define BORDER_COLOR_NORMAL 0
#endif
#ifndef BORDER_COLOR_FOCUSED
#define BORDER_COLOR_FOCUSED 1
#endif
#ifndef BORDER_COLOR_PRESSED
#define BORDER_COLOR_PRESSED 2
#endif
#ifndef BACKGROUND_COLOR
#define BACKGROUND_COLOR 3
#endif
#ifndef TEXT_COLOR_NORMAL
#define TEXT_COLOR_NORMAL 4
#endif
#ifndef TEXT_COLOR_FOCUSED
#define TEXT_COLOR_FOCUSED 5
#endif
#ifndef TEXT_COLOR_PRESSED
...
int preferance()
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        { // Can't select same as 1st or 2nd
...
int login()
{
    ...
    // Draw gradient header label as you have
int headerHeight = 40;
...
// Draw the form panel WITHOUT a title (empty string) so it doesn't draw duplicate login text
...
void SetupGUIColors()
{
    GuiSetStyle(DEFAULT, BACKGROUND_COLOR, 0x00000000); // Transparent, let gradient show
...
int main(void)
{
    ...
    {
        BeginDrawing();
        // Draw vertical gradient background from dark blue to purple
       DrawRectangleGradientV(0, 0, GetScreenWidth(), GetScreenHeight(),
        ...
        if (showLogout)
        {
            ...
            // Decorative header rectangle with horizontal gradient fill
            // Header label on top of the gradient bar
